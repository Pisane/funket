...
async function signupApi(id, pw, email, addr, ref)
{
...
function* signupFlow (id, pw, email, addr, ref) {
    let response;
    try {
        response = yield call (signupApi, id, pw, email, addr, ref);
...
function* signupWatcher () { 
    ...
    while( true ){
        ...
        const task = yield fork(signupFlow, id, pw, email, addr, ref);
